      ...
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        <SheetContent
          ...
          className={cn(
            ...
            // Touch affordances for mobile sidebar content.
            "touch-pan-y overscroll-contain",
            // Ensure tap targets are comfortably sized on touch.
            "**:data-[sidebar=menu]:gap-1",
            "**:data-[sidebar=menu-button]:min-h-11 **:data-[sidebar=menu-button]:px-3",
            "**:data-[sidebar=menu-button]:[&_svg]:size-5",
            "**:data-[sidebar=header]:p-3 **:data-[sidebar=footer]:p-3"
          )}
          style={
            {
...
function SidebarContent({
  ...
  return (
    <div
      ...
      className={cn(
        "no-scrollbar flex min-h-0 flex-1 flex-col gap-0 overflow-auto overscroll-contain touch-pan-y group-data-[collapsible=icon]:overflow-hidden",
        className
      )}
      {...props} />
  );
